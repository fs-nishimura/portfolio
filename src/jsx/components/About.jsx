  ...
  render() {
    return (
      <div className="page-about">
        ...
        - Javascript(Mainly Vue.js, learning React), (S)CSS, PHP(Wordpress, Cake2), (X)HTML(5)<br />
      - Some mySQL, Python<br />Best at creating interactive websites with "pixel perfect" coding<br />
